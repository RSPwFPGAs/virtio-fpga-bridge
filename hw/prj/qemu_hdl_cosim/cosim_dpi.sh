...
export COSIM_PORT_2nd=2029
source gen_dpi_2nd.sh

cd xsim
rm xsim* webtalk* -rf

xsc ../../../src/qemu_hdl_cosim/sim_ip/QEMUPCIeBridge/hdl/dpi-pcie.c \
    ../../../src/qemu_hdl_cosim/sim_ip/QEMUPCIeBridge/hdl/dpi-pcie.2nd.c --additional_option "-lczmq -lzmq" -v
